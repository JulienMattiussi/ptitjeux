 ...
 */
export function GameFrame({ children, size = 'md', overlay }: Props) {
  return (
    <div
      className={`relative mx-auto w-full ${SIZE_CLASS[size]} rounded-3xl border border-gray-200/80 bg-white/80 p-5 shadow-xl shadow-gray-300/30 backdrop-blur sm:p-8 dark:border-gray-800/80 dark:bg-gray-900/70 dark:shadow-black/30`}
    >
