...
export function Board({ state, onCellClick }: Props) {
                ...
                const cellClass =
                  s === 'in'
                    ...
                    : s === 'out'
                      ...
                      : 'bg-white text-gray-800 hover:bg-amber-50 hover:shadow-sm hover:scale-[1.02] dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800'
                return (
                  <button
                    type="button"
                    key={`${x}-${y}`}
